...
const entry: HistoryEntry = {
  ...
  title: "Why Fax Is Still Used",
  description:
    "Why a technology widely declared obsolete is still in active use, and what the persistence reveals about trust, evidence, and the cost of switching.",
  summary:
  ...
  body: [
    ...
    },
    {
      kind: "heading",
      level: 2,
      text: "The workflow inertia argument",
    },
    {
      kind: "paragraph",
      text: "Alongside trust sits inertia, and the two are easy to confuse. Some fax use genuinely needs fax's evidentiary standing; some merely follows a path of least resistance because a process was once built around fax and never deliberately rebuilt. Both keep the machine running, but they are different problems, and conflating them leads to the mistaken belief that fax persists only out of habit. Inertia is real, but it is not the whole, and it is not the strongest, reason.",
    },
    {
      kind: "paragraph",
    ...
    },
    {
      kind: "heading",
      level: 2,
      text: "The trade-offs of continued use",
    },
    {
      kind: "table",
      caption:
        "Continued fax use is a considered trade, not a simple failure to modernise.",
      headers: ["What continued fax use preserves", "What it costs to keep"],
      rows: [
        [
          "A recognised, sanctioned method in rule-bound processes",
          "Maintaining a channel most of the organisation no longer uses",
        ],
        [
          "Self-contained verifiability needing no shared system",
          "Poorer fidelity and integration than digital document handling",
        ],
        [
          "Trust earned by long use and codified acceptance",
          "Dependence on a capability tied to ageing infrastructure",
        ],
        [
          "Continuity with counterparties that have not moved on",
          "An indefinitely deferred, never-finished modernisation",
        ],
      ],
    },
    {
      kind: "paragraph",
      text: "Read as a trade rather than an oversight, continued fax use is coherent. Organisations keep it because the specific thing it still provides — a sanctioned, self-contained, trusted act of transmission — has a real value that the cost of maintaining a mostly idle channel does not yet exceed. The day that balance tips is the day fax actually ends, and that day is set by the terms of the trade, not by the availability of better technology, which has been present for a long time already.",
    },
    {
      kind: "callout",
      tone: "note",
      title: "A note on dates",
      text: "This page explains why fax persists rather than predicting when it will stop. The pace of any further decline differs sharply by sector and jurisdiction; specific timelines are contested and are deliberately not asserted here.",
    },
    {
      kind: "heading",
      level: 2,
      text: "What would actually have to change",
    },
    {
      kind: "paragraph",
      text: "Ending fax does not require a better technology, because a better technology already exists and has for years. It requires a different set of conditions to be met. The rules that name fax as an accepted method would have to be rewritten to name something else with equivalent standing. The trust that took long use to accrue would have to be deliberately reassigned to a digital substitute rather than left to migrate on its own. And the coordination cost of moving every counterparty in a relationship at once would have to be borne by someone with the authority and incentive to bear it.",
    },
    {
      kind: "paragraph",
      text: "None of those is a technical task; all of them are institutional ones, which is why progress on them is slow and uneven. The companion analysis of analog versus digital fax shows the carrier beneath fax can be replaced without disturbing any of this, and the long view in the history of business faxing shows how thoroughly the obligation became embedded in the first place. Fax will end not when something better is built, but when the trust, the rules, and the coordination are deliberately moved off it — and until each of those conditions is met somewhere, fax will still, in that place, be used.",
    },
  ],
  faqs: [
    {
      q: "If better technology exists, why is fax still used at all?",
      a: "Because fax's surviving job is not delivery but standing: in rule-bound processes a faxed transmission is a sanctioned, recognised act. A superior technology does not automatically inherit that legal and evidentiary standing, so the niche holds until the rule changes.",
    },
    {
      q: "Is fax kept only out of habit?",
      a: "Habit and inertia are part of it, but not the strongest part. Some fax use genuinely needs its evidentiary standing; some merely follows an unrebuilt process. The first cannot be ended by an organisation's own effort, which is why it persists more durably than habit alone would.",
    },
    {
      q: "What would it actually take to end fax?",
      a: "Not better technology, which already exists, but institutional change: rewriting rules that name fax, deliberately reassigning accrued trust to a digital substitute, and bearing the cost of moving every counterparty at once. These are organisational tasks, which is why they move slowly.",
    },
  ],
  related: [
  ...
  keywords: [
    ...
    "fax legal requirement",
    "fax trust and records",
    "fax persistence",
