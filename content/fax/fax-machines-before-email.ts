...
const entry: HistoryEntry = {
  section: "fax",
  slug: "fax-machines-before-email",
  title: "Fax Machines Before Email",
  description:
  ...
  body: [
    ...
    {
      kind: "paragraph",
      text: "That residue is the honest answer to what fax was before email: a complete workflow that email reduced to a single surviving habit. The machine in the corner was once the fast lane for documents; what outlasted it was not the lane but the one errand nothing newer had fully agreed to take over.",
    },
  ],
  faqs: [
    {
      q: "What made fax the default office channel before email?",
      a: "It was the only option that was fast, carried the actual document including a signature, and needed no shared computer system. Post was slow, courier was costly over distance, and the phone moved content but not the artefact.",
    },
    {
      q: "Did people consider faxing reliable at the time?",
      a: "Reliable enough to depend on, not good enough to trust blindly. Pages could arrive degraded and important documents were often followed by a posted original, but a workable copy arriving the same day still beat the alternatives.",
    },
    {
      q: "Why didn't email immediately replace fax?",
      a: "Email replaced routine correspondence quickly but not the part of fax tied to signed, procedurally weighted pages. It made fax optional rather than obsolete, demoting it from default channel to a narrow, deliberate choice.",
    },
  ],
  related: [
  ...
  keywords: [
    ...
    "pre-email office workflow",
    "fax office routine",
    "document delivery before email",
    "history of office fax",
  ],
  modernTools: ["fax-app"],
  cluster: "fax-history",
};
