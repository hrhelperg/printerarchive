...
const entry: HistoryEntry = {
  section: "history",
  slug: "printing-in-the-1980s",
  title: "Printing in the 1980s",
  description:
    "How impact-era output shaped the 1980s desk: continuous paper, mechanical pacing, and a workday organised around a loud, physical machine.",
  summary:
  ...
  body: [
    ...
    },
    {
      kind: "heading",
      level: 2,
      text: "How the workday adapted around the printer",
    },
    {
      kind: "paragraph",
    ...
    {
      kind: "paragraph",
      text: "This had a quiet consequence for how work was sequenced. Knowing that output took measurable time and attention, workers batched it — assembling several documents and committing them together rather than printing each as it was finished. The printer thus shaped not only the desk but the order in which tasks were done.",
    },
    {
      kind: "heading",
      level: 2,
      text: "The constraints operators simply lived with",
    },
    {
      kind: "paragraph",
      text: "Several limits of the era were not solved during it; they were absorbed into normal practice. Noise was managed by placement and acoustic hoods rather than eliminated. Graphical weakness was managed by not asking the machine for graphics. The labour of bursting continuous stock into sheets and stripping its margins was simply part of producing a document. None of this read as hardship to the people doing it, because there was no contemporaneous alternative against which it registered as friction — a point worth holding when later decades made the same tasks look antiquated.",
    },
    {
      kind: "callout",
      tone: "note",
      title: "A note on dates",
      text: "This page is organised around the operational character of the decade rather than specific years, products, or companies. The arrangements described overlapped and arrived unevenly across organisations rather than in a single datable sequence.",
    },
    {
      kind: "heading",
      level: 2,
      text: "What the decade set up next",
    },
    {
      kind: "paragraph",
      text: "The 1980s ended with two unresolved tensions that the following decade inherited directly. First, the per-desk machine was an obvious inefficiency once quieter, sheet-fed output existed, which pointed toward sharing. Second, output that now looked typeset raised the expected standard for every document, transactional ones included. Both tensions are taken up in the archive's account of printing in the 1990s, which treats the shared machine and the escalating expectation as the defining problems of the decade that followed. The 1980s did not solve them; it made them unavoidable.",
    },
  ],
  faqs: [
    {
      q: "Why was continuous-form paper so central to 1980s office printing?",
      a: "Impact printers were driven by sprocket holes along a continuous web of fan-fold paper rather than fed discrete sheets. That single mechanical fact dictated desk layout, storage, and the post-printing labour of separating and trimming pages, so it shaped the whole working environment, not just the output.",
    },
    {
      q: "Did quieter printing simply replace impact printing in the 1980s?",
      a: "No. Quieter, sharper output coexisted with impact rather than displacing it, because it lost the built-in multi-part copy and added per-sheet cost and handling. Offices ran both: impact for transactional volume and copies, the newer option where a document's appearance mattered.",
    },
    {
      q: "Why frame the decade around the machine rather than the document?",
      a: "Because in the 1980s the worker operated the printer rather than dispatching to it. The machine's pace, footprint, and tending requirements organised the desk and the order of tasks, so the operational reality of the era is best understood from the machine outward.",
    },
  ],
  related: [
  ...
  keywords: [
    ...
    "1980s office printing",
    "continuous form paper",
    "impact printing history",
    "office technology history",
  ],
